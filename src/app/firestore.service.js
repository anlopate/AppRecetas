...
let FirestoreService = (() => {
    ...
    let _classThis;
    var FirestoreService = _classThis = class {
        ...
        borrar(coleccion, documentId) {
            return this.angularFirestore.collection(coleccion).doc(documentId).delete();
        }
        modificar(coleccion, documentId, datos) {
            return this.angularFirestore.collection(coleccion).doc(documentId).set(datos);
        }
        consultarPorId(coleccion, documnetId) {
            return this.angularFirestore.collection(coleccion).doc(documnetId).snapshotChanges();
        }
    };
